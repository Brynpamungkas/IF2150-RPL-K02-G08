...
```
docs/
	KXX_GYY_AiUsage.md             # dokumentasi penggunaan AI
	...
	M1/                             # milestone 1
		...
		KXX_GYY_Tugas-TB.md            # dokumen tugas besar milestone 1
	M2/                             # milestone 2
		...
	...
...
2. **Invite anggota kelompok.** Perwakilan yang fork tadi otomatis jadi owner dari repo fork tersebut. Masuk ke **Settings → Collaborators and teams → Add people**, lalu invite semua anggota kelompok satu per satu. Setiap anggota hanya akan punya akses ke repo fork kelompok sendiri, bukan ke repo kelompok lain atau ke organisasi.
3. **Aktifkan notifikasi rilis.** Buka repository original (bukan fork kalian), klik tombol **Watch → Custom**, lalu centang **Releases**. Dengan ini kalian akan otomatis dapat notifikasi setiap kali panitia merilis tubes baru, tanpa perlu bolak-balik cek manual.
